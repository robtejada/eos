...
class MGSIO3_LIQUID_EOS:
    ...
    def get_p_rhot(self, rho: ArrayLike, T: ArrayLike) -> np.ndarray:
    ...
    def get_s_pt(self, P: ArrayLike, T: ArrayLike, tab=True) -> np.ndarray:
        ...
        if tab:
            return self.get_s_pt_tab(P, T) * self.S_conv_cgs # SI to cgs
        else:
