...
Importantly, this is the [second release](https://zenodo.org/records/19634806) with an updated eos mixtures module called `eos_class.py`. This class handles all the available H-He-Z mixtures, with Z primarily being the water EOS of Haldemann et al (2020; AQUA). 

# H-He EOS quantities for planetary evolution [![DOI](https://zenodo.org/badge/639560032.svg)](https://zenodo.org/doi/10.5281/zenodo.19634806) 
### EOS zip downloadable file (if GIT LFS Storage is limited): [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19634806.svg)](https://doi.org/10.5281/zenodo.19634806)
