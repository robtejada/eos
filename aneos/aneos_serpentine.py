...
from aneos import aneos_rhot

"""
This code was originally coded by C. Mankovich from his alice repo: https://github.com/chkvch/alice
"""
...
class eos:
    ...
    def regularize_to_ps(self):
        ...
        with open('/Users/ankansur/Desktop/ongp-master/v2/eos/aneos_%s_ps.dat' % self.material, 'w') as fw:
            print ("opened")
            for i, logpval in enumerate(logpvals):
                for j, logsval in enumerate(logsvals):
